...
class ProductRepository extends BaseProductRepository
{
    ...
    public function getQueryBuilderBySearchDataForAdmin($searchData)
    {
       ...
       */
        ...
        $sort_field = "p.update_date";
        $sort_type = "DESC";
        if (!empty($searchData['field_sort']) && $searchData['field_sort']) {
            switch($searchData['field_sort'])
            {
                case "1":
                    $sort_field = "p.update_date";
                    $sort_type = "ASC";
        ...
        //$this->queries->customize(QueryKey::PRODUCT_SEARCH_ADMIN, $qb, $searchData);
