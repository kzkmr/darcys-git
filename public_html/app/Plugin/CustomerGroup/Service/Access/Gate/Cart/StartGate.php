...
namespace Plugin\CustomerGroup\Service\Access\Gate\Cart;
...
class StartGate implements GateInterface
{
     ...
     * @param AbstractEntity|Product $entity
     * @return bool
     */
    public function pass(TokenInterface $token, AbstractEntity $entity): bool
    {
        if ($entity->hasGroups() > 0) {
            ...
            if ($token instanceof UsernamePasswordToken) {
                ...
                return $customer->getGroupProducts()->contains($entity);
            }
        }
    ...
    {
        return ProductVoter::CART === $attribute && $request->getEntity() instanceof Product;
    }
}
