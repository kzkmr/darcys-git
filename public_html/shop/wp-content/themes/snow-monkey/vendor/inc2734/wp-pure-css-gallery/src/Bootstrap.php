...
class Bootstrap {
	...
	public function __construct() {
		add_filter( 'post_gallery', [ $this, '_post_gallery' ], 10, 2 );
	 ...
	 */
	public function _post_gallery( $output, $attr ) {
		$post = get_post();
	...
	public function _enqueue_styles() {
		wp_enqueue_style(
			'wp-pure-css-gallery',
			get_template_directory_uri() . '/vendor/inc2734/wp-pure-css-gallery/src/assets/css/wp-pure-css-gallery.css',
			[],
			filemtime( get_template_directory() . '/vendor/inc2734/wp-pure-css-gallery/src/assets/css/wp-pure-css-gallery.css' )
		);
	}
	...
	public function _add_editor_style() {
		add_editor_style(
			[
				'vendor/inc2734/wp-pure-css-gallery/src/assets/css/wp-pure-css-gallery.css',
			]
		);
	}
}
