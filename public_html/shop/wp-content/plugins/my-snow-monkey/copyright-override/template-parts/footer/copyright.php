...
<div class="ec-footer-role">
    <div class="ec-footer-role__inner">
        <div class="ec-footer-role__top sp-none not_store hide">
        ...
        <div class="ec-footer-role__top sp-none is_store hide">
            <ul class="ec-footer-horizontal-navi">
        ...
        <div class="ec-footer-role__top pc-none not_store hide">
            <ul class="ec-footer-navi">
                <li class="ec-footer-navi__link ec-footer-navi__link_wide">
                    <a href="<?php echo ec_url(); ?>/products/list">ONLINE SHOP</a>
                </li>
        ...
        <div class="ec-footer-role__top pc-none is_store hide">
            <ul class="ec-footer-navi">
                <li class="ec-footer-navi__link">
                    <a href="<?php echo ec_url(); ?>/mypage/menu">トップ</a>
                </li>
