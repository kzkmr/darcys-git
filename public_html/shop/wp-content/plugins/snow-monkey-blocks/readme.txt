...
* [Pickup Slider] Hide scrollbar.
* [Button] Add wrap option.
...
* [Media text] Changed the image position setting to the block toolbar.
* [Section (with background image/video)] Fixed an issue where images for PC/tablet use were not inherited to smaller sizes.

= 9.2.0 =
* [Recent posts] Fix columns setting bug.
* [RSS] Fix columns setting bug.
* [Taxonomy posts] Fix columns setting bug.
* [Section (with background image/video)] Add image repeat setting.

= 9.1.0 =
* [Recent posts] Fix columns setting bug.
* [Recent posts] Columns setting only show layout setting is rich-media or panel.
* [RSS] Fix columns setting bug.
* [RSS] Columns setting only show layout setting is rich-media or panel.
* [Taxonomy posts] Fix columns setting bug.
* [Taxonomy posts] Columns setting only show layout setting is rich-media or panel.
* [Slider] Fix fade bug.
* [Slider] Add autoplay setting.
* [Slider] Add caption setting.
* [Pickup slider] Fix bug that alignfull/alignwide not applied.
* [Pickup slider] Add autoplay setting.
...
= 8.8.1 =
* Remove `snow_monkey_blocks_enqueue_slick` filter hook.
* Fixed bug that broken headings block templates.
* Update parallax effect.
* [Slider / Thumbnail gallery] Changed the script of slick-caroucel is loaded when required.
* [Directory structure] Changed to not fold back.

= 8.8.0 =
* [Slider] Add image aspect ratio setting.
* [Box] Fix box border radius style bug.
* [Section (with background image/video)] Fixed a bug that the border is displayed when the mask opacity is 0.

= 8.7.0 =
* Changed to display an unlink button for blocks with links.
* Change Japanese translation: 透明度 to 不透明度
* [Pricing table] Changed to display the button only when both label and URL are set.
* [Box] Add background opacity setting.
* [Item (Banner)] Change HTML structure.
* [Item (Block link)] Change HTML structure.

= 8.6.2 =
* Remove moment.
* [Countdown] Fixed a bug that calendar date cannot be selected.
...
* [Recent posts] Add item title tag setting.
* [Recent posts] Add item thumbnail size setting.
* [Taxonomy posts] Add item title tag setting.
* [Taxonomy posts] Add item thumbnail size setting.
* [RSS] Add item title tag setting.
* Add width/height attribute to image.
...
* [Slider] Add attributes width and height.

= 8.4.1 =
* [Taxonomy terms] Fixed minor bugs.

= 8.4.0 =
* Add image delete button to toolbar with image.
* Add new block "Taxonomy terms".
* [Panels] Changed to save the link URL even if the link label is not entered.
